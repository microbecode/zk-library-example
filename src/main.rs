...
/// How many leading zeros do we require
const REQUIRE_ZEROS: usize = 5;
/// What is the preimage (in reality the prover should keep this secret)
const PREIMAGE_STR: &str =
...
/// Modified from example at https://docs.rs/bellman/0.14.0/bellman/index.html
fn main() {
